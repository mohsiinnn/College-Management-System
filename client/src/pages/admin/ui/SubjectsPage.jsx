// import { Search, Plus, BookOpen, Building2, FileText, Bookmark, Eye, Pencil } from "lucide-react";
...
//           <div>
//             <h1 className="text-3xl font-semibold text-emerald-600">Subjects</h1>
//             <p className="text-slate-600 text-sm">Manage academic subjects and curriculum</p>
//           </div>
...
//             <h2 className="text-base font-semibold text-slate-900">All Subjects (2)</h2>
//             <button
...
//             {(subjects === null) ? (
//               <div>
//                 <p className="text-slate-900 font-medium">No subjects yet</p>
//                 <p className="text-sm text-slate-500 mt-1">
//                   Subjects will appear here once they register.
//                 </p>
//               </div>
//             ) :
