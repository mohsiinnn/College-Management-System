        ...
        <div className="min-h-screen bg-slate-50">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
              <div>
                <h1 className="text-3xl font-semibold text-emerald-600">Classes</h1>
                <p className="text-slate-600 text-sm">Manage academic classes and sections</p>
              </div>
            ...
            <div className="mt-6 rounded-xl border border-slate-200 bg-white shadow-sm">
              ...
              <div className="px-6 py-16 text-center items-center justify-center">
                {(classes === null) ? (
                  <div>
                    <p className="text-slate-900 font-medium">No classes yet</p>
                    <p className="text-sm text-slate-500 mt-1">
                      Classes will appear here once they register.
                    </p>
                  </div>
                ) :
...
// import { Search, Plus, Building2, UsersRound, School, Eye, Pencil, MoreVertical } from "lucide-react";
// import { useSelector } from "react-redux";
// import { useNavigate } from "react-router-dom";
