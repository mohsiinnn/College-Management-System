...
import { addAttendance, addBatchAttendance, createStudentProfile, deleteAllStudents, deleteStudent, deleteStudentsFromClass, getActiveStudents, getAllStudents, getClassAttendance, getStudentDetail, getStudentOnly, removeAllStudentAttendanceFromSubject, removeAllStudentsAttendance, removeStudentAttendance, removeStudentAttendanceFromSubject } from '../controller/studentController.js'
...
studentRouter.get('/class/:classId/attendance', isAuthenticated, getClassAttendance);
studentRouter.post('/class/:classId/attendance', isAuthenticated, addBatchAttendance);
