...
import { createTeacherProfile, deleteAllTeachers, deleteTeacher, getAllTeachers, getOneTeacher, getTeacherDetail, getTeachers, updateTeacherSubject } from '../controller/teacherController.js';
...
teacherRouter.get('/all-teachers', isAuthenticated, restrictAdmin, checkAdminApproval, getAllTeachers);
teacherRouter.get('/active-teachers', isAuthenticated, restrictAdmin, checkAdminApproval, getTeachers);
teacherRouter.get('/getTeacher/:id', isAuthenticated, restrictAdmin, checkAdminApproval, getTeacherDetail);
teacherRouter.get('/getOneTeacher/:id', isAuthenticated, checkTeacherApproval, getOneTeacher);
